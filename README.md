...
CSS files are compiled into the **_/css/** directory from the files imported by the **_ui/css/app.main.scss** file. Note that whenever a new .scss file is added, it must be manually added to the **_ui/css/app.main.scss** file.
...
```
* **CSS/SASS**
	* The run grunt task will check the **_/css/app.main.scss** file and compile all the specified scss files into **_/css/app.main.css**. This CSS style is expanded, have a sourcemap file, trace, debug info and line number. This is the CSS file loaded when viewing the development site.
* **JavaScript**
...
* **CSS/SASS**
	...
	* This time, it will compile to **_/css/app.main.min.css** but will be compressed and will not include any of the debug options turned on for the development build. 
