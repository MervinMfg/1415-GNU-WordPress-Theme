 ...
 * 
 * Style guide template file
 *
 * This is a basic style guide with a lot of general elements
 * one would need to style within a WordPress theme.
 *
 * @package WordPress
...
<div role="main" class="style-guide">
    ...
    <section>
        <header class="container">
            <h2>Grid</h2>
            <p>This section is going to show an example of how to utilize the grid components. Assign the grids via the CSS module instead of adding them directly to HTML elements. Two examples are provided below, see _style-guide.scss for implementation method.</p>
        </header>
    ...
    <section class="grouping">
        ...
        <div class="example">
            <figure>
                <img src="http://lorempixum.com/680/400/abstract/?r" alt=""/>
                <figcaption>
    ...
    <section class="text-semantics">
        ...
        f478b9aa89442d2922b915a23dd1ac4c
