...
GNU.FeaturedPosts.prototype = {
	init: function () {
		...
		$('.featured-posts .blog-post .post-link').on('mouseenter', function () {
	...
	scrollPosts: function () {
		...
		$('.featured-posts .blog-post').removeAttr('style');
		...
		if ( GNU.Main.utilities.responsiveCheck() === 'large' ) {
			...
			tween = new TweenMax.to('.featured-posts .featured-post-list .blog-post', 1, {marginLeft: "0px", marginRight: "0px", ease: Linear.easeNone});
