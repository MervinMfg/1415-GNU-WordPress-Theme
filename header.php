...
<body <?php body_class($bodyClass); ?>>
	<!-- Tag Manager -->
	<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-T8D6V8"
	...
	<div id="page">
		...
		<div id="main" class="site-main">
			<div class="global-alert">
				<p class="small message usd cad">Up to 30% OFF most 14/15 products! FREE standard shipping on all orders over $75</p>
				<p class="small message eur">Up to 30% OFF most 14/15 products! FREE standard shipping on all orders over €75</p>
			</div>
